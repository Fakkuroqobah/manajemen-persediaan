...
<div class="row">
    ...
    <div class="col-md-2 mb-2">
        <a href="{{ route('customer.index') }}" class="text-reset text-decoration-none">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
    ...
    <div class="col-md-2 mb-2">
        <a href="{{ route('supplier.index') }}" class="text-reset text-decoration-none">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
    ...
    <div class="col-md-2 mb-2">
        <a href="{{ route('barang-masuk.index') }}" class="text-reset text-decoration-none">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
    ...
    <div class="col-md-2 mb-2">
        <a href="{{ route('penjualan.index') }}" class="text-reset text-decoration-none">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
    ...
    <div class="col-md-2 mb-2">
        <a href="{{ route('retur.index') }}" class="text-reset text-decoration-none">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
