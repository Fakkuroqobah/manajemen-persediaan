...
<div class="row">
    <div class="col-md-2 mb-2">
        <a href="{{ route('cashier_barang') }}" class="text-reset text-decoration-none">
    ...
    <div class="col-md-2 mb-2">
        <a href="{{ route('cashier_customer') }}" class="text-reset text-decoration-none">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
    ...
    <div class="col-md-2 mb-2">
        <a href="{{ route('jual.index') }}" class="text-reset text-decoration-none">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $data['keluar'] }}</div>
                                </div>
                                <div class="col">
    ...
    <div class="col-md-2 mb-2">
        <a href="{{ route('cashier_retur') }}" class="text-reset text-decoration-none">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $data['retur'] }}</div>
                                </div>
                                <div class="col">
