            ...
            <form method="POST" id="form-tambah">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="jumlah" class="form-control" placeholder="Masukan jumlah barang" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label for="">Tanggal barang masuk</label>
                        <input type="date" name="tanggal" class="form-control" placeholder="Masukan tannggal barang masuk" autocomplete="off">
                    </div>
                </div>
...
$(document).ready(function() {
    var table = $('#table').DataTable({
        ...
        columns: [
            ...
            { data: 'supplier.nama_supplier', name: 'nama_supplier' },
    ...
    var modalEdit_id_supplier = $('#modal-edit select[name="id_supplier"]');
    ...
    $('#table').on('click', '.edit', function(e) {
        ...
        var url = "{{ route('barang-masuk.show', ':id') }}";
        url = url.replace(':id', $(this).attr('data-id'));

        $('#modal-edit button[name="submit"]').attr('data-id', $(this).attr('data-id'));
        modalEdit_id_supplier.attr("disabled", true);
        ...
        $.ajax({
            ...
            modalEdit_id_supplier.attr("disabled", false);
            modalEdit_id_supplier.trigger('focus');
            modalEdit_id_supplier.val(msg.data.id_supplier);

            modalEdit_id_barang.attr("disabled", false);
            modalEdit_id_barang.val(msg.data.id_barang);

            modalEdit_jumlah.attr("disabled", false);
            modalEdit_jumlah.val(msg.data.jumlah_barang_masuk);

            modalEdit_tanggal.attr("disabled", false);
            modalEdit_tanggal.val(msg.data.tanggal_barang_masuk);
        }).fail(function(err) {
    ...
    edit.click(function(e) {
        ...
        var url = "{{ route('barang-masuk.update', ':id') }}";
        url = url.replace(':id', $(this).attr('data-id'));
    ...
    $('#table').on('click', '.delete', function(event) {
        var url = "{{ route('barang-masuk.destroy', ':id') }}";
        url = url.replace(':id', $(this).attr('data-id'));
