            ...
            <form method="POST" id="form-tambah">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" class="form-control" placeholder="Masukan nama customer" autofocus autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label for="">Alamat customer</label>
                        <input type="text" name="alamat" class="form-control" placeholder="Masukan alamat customer" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label for="">Telepon customer</label>
                        <input type="number" name="telepon" class="form-control" placeholder="Masukan telepon customer" autocomplete="off">
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    $('#table').on('click', '.edit', function(e) {
        ...
        $.ajax({
            ...
            modalEdit_nama.val(msg.data.nama_customer);

            modalEdit_alamat.attr("disabled", false);
            modalEdit_alamat.val(msg.data.alamat_customer);

            modalEdit_telepon.attr("disabled", false);
            modalEdit_telepon.val(msg.data.telepon_customer);
        }).fail(function(err) {
